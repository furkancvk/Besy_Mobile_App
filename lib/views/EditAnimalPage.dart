...
class EditAnimalPage extends StatefulWidget {
  const EditAnimalPage({Key? key}) : super(key: key);
...
class _EditAnimalPageState extends State<EditAnimalPage> {
  ...
  List<DropdownMenuItem<String>> healthItems = [
    ...
    const DropdownMenuItem(child: Text("Hasta/Sağlıksız"),value: "Hasta/Sağlıksız"),
  ];
    ...
    return SafeArea(
        child: Scaffold(
            appBar: AppBar(
              ...
              title: const Text('PROFİLİ DÜZENLE', style: TextStyle(
                fontFamily: 'Monda',
            ...
            body: ListView(
              ...
              children: [
                ...
                Center(
                  child: AppButtons.appElevatedButton(name: 'GÜNCELLE', onPressed: (){
                    print('güncellendi');
                  }),
                )
              ],
